...
const generateWAMessageContent = async (message, options) => {
    ...
    if ('text' in message) {
       ...
       pollResultSnapshotMessage.contextInfo = {
        ...
        (_b = message === null || message === void 0 ? void 0 : message.poll) === null || _b === void 0 ? void 0 : _b.selectableCount || (_b = message === null || message == void 0 ? void 0 : message.poll) === null || _b === void 0 ? void 0 : _b.selectableCount = 0;
        (_c = message === null || message === void 0 ? void 0 : message.poll) === null || _c === void 0 ? void 0 : _b.toAnnouncementGroup || (_c = message === null || message === void 0 ? void 0 : message.poll) === null || _c === void 0 ? void 0 : _c.toAnnouncementGroup = false;
...
const generateWAMessageFromContent = (jid, message, options) => {
    ...
    if (quoted && !(0, WABinary_1.isJidNewsletter)(jid)) {
        ...
        if (key === 'requestPaymentMessage') {
            if (((_a = innerMessage?.requestPaymentMessage) && ((_c = (_b = innerMessage?.requestPaymentMessage)?.noteMessage)?.extendedTextMessage))) {
                requestPayment = (_e = (_d = innerMessage?.requestPaymentMessage)?.noteMessage)?.extendedTextMessage;
            } else if (((_f = innerMessage?.requestPaymentMessage) && ((_h = (_g = innerMessage?.requestPaymentMessage)?.noteMessage)?.stickerMessage))) {
                requestPayment = (_k = (_j = innerMessage.requestPaymentMessage)?.noteMessage)?.stickerMessage;
            }
        }
...
function getAggregateVotesInPollMessage({ message, pollUpdates }, meId) {
	var _a, _b, _c;
    const msg = (0, exports.normalizeMessageContent)(message);
    const opts = ((_a = msg === null || msg === void 0 ? void 0 : msg.pollCreationMessage) === null || _a === void 0 ? void 0 : _a.options) || ((_b = msg === null || msg === void 0 ? void 0 : msg.pollCreationMessageV2) === null || _b === void 0 ? void 0 : _b.options) || ((_c = msg === null || msg === void 0 ? void 0 : msg.pollCreationMessageV3) === null || _c === void 0 ? void 0 : _c.options) || [];
