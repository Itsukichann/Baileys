...
exports.default = (config) => {
    ...
    return {
        ...
        fetchImageUrl: async (jid, suki) => {
            ...
            if (!contact) {
                return sock === null || suki === void 0 ? void 0 : suki.profilePictureUrl(jid);
            }
            if (typeof contact.imgUrl === 'undefined') {
                contact.imgUrl = await (suki === null || suki === void 0 ? void 0 : suki.profilePictureUrl(jid));
            }
            return contact.imgUrl;
        },
        fetchGroupMetadata: async (jid, suki) => {
            if (!groupMetadata[jid]) {
                const metadata = await (suki === null || suki === void 0 ? void 0 : suki.groupMetadata(jid));
                if (metadata) {
